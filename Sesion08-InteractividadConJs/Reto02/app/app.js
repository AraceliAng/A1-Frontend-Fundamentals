...
function classToggleArgentina() {
  this.classList.toggle('argentina-photos2');
  this.classList.toggle('argentina-photos3');
}
document.querySelector('#argentina').addEventListener('click', classToggleArgentina);

function classToggleAngeles() {
  this.classList.toggle('angeles-photos2');
  this.classList.toggle('angeles-photos3');
}
document.querySelector('#angeles').addEventListener('click', classToggleAngeles);